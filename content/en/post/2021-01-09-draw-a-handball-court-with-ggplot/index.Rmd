...
free_thr_compl1 <- rbind(free_thr9_1_1, free_thr9_1, free_thr9_1_2)
...
free_thr_compl2 <- rbind(free_thr9_2_2, free_thr9_2, free_thr9_2_1)
...
court <- function(vertical = FALSE, flip = FALSE, plotly = FALSE){
  ...
  plot <- ggplot(mapping = eval(parse(text = type_of_plot))) +
    ...
    geom_path(data = free_thr_compl1, linetype = 'dashed', size = 1) +
    geom_path(data = free_thr_compl2, linetype = 'dashed', size = 1) +
